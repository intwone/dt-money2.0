...
import { ArrowCircleDown, ArrowCircleUp, MagnifyingGlass, X } from 'phosphor-react'
...
export function NewTransactionModal() {
  ...
  const { register, handleSubmit, formState, control, reset } = useForm<NewTransactionFormInputs>({
